  ...
  function install(payload) {
    ...
    shadow.innerHTML = `
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        h1 { margin:0; padding:0 0 32px; font-size:24px; line-height:28.8px; font-weight:400; }
      ...
      <div class="view" role="dialog" aria-modal="true" aria-labelledby="blackbox-title">
        ...
        <main class="main">
          <div class="content">
            ...
            <section class="section" id="themes" hidden><h2>Themes</h2><div class="card"><div class="empty">No themes installed.</div></div></section>
          </div>
        </main>
      </div>`;

    const addonList = shadow.querySelector(".plugins");
    ...
    for (const addon of payload.addons) {
      ...
      const preview = addon.screenshot
        ...
        : `<div class="plugin-preview plugin-preview-fallback">${BOX_ICON}</div>`;
