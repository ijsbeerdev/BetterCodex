...
Download `blackbox-0.1.0-windows-x64.zip` from the latest GitHub release, extract the entire ZIP, then double-click **Install Blackbox.cmd**. The package includes its own verified portable runtime, so Node.js and npm are not required.
